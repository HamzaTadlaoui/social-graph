...
fun PersonProfileScreen(
    ...
    Scaffold(
                    ...
                    Row(
                        ...
                        IconButton(onClick = {
                            when (tie.kinship) {
                                ...
                                -> confirmTarget = tie
                                else -> viewModel.confirmImplied(tie, kinshipLabel)
                            }
                        }) {
        ...
        // outright rather than recording on the first tap. Kept outside the
        // lazy list so it still shows even if the row that opened it has
        // since scrolled out of composition.
